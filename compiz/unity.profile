...
s0_put_next_output_key = <Shift><Control><Primary><Super>Up
...
s0_panel_opacity = 0.500000
s0_panel_opacity_maximized_toggle = false
s0_launcher_opacity = 0.500000
s0_icon_size = 34
s0_edge_responsiveness = 4.000000
s0_reveal_pressure = 5
s0_overcome_pressure = 1
s0_decay_rate = 15
s0_stop_velocity = 10
...
[core]
s0_active_plugins = core;composite;opengl;decor;move;gnomecompat;mousepoll;wall;resize;put;place;vpswitch;regex;compiztoolbox;session;animation;workarounds;grid;shift;imgsvg;imgpng;unitymtgrabhandles;wobbly;fade;scale;expo;ezoom;unityshell;
