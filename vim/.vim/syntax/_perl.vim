...
if !exists("perl_no_extended_vars")
  ...
  syn match  perlVarSimpleMember	"\(->\)\={\I\i*}" nextgroup=perlVarMember,perlVarSimpleMember contains=perlVarSimpleMemberName,perlMethod contained
  syn match  perlVarSimpleMemberName	"\I\i*" contained
  syn region perlVarMember	matchgroup=perlVarPlain start="\(->\)\=\[" skip="\\]" end="]" contained contains=@perlExpr nextgroup=perlVarMember,perlVarSimpleMember,perlMethod
  syn match  perlMethod		"\(->\)\I\i*" nextgroup=perlVarMember,perlVarSimpleMember,perlMethod
  syn region perlMethod		matchgroup=perlMethod start="\(->\)\=\\(" skip="\\)" end=")" contained contains=@perlExpr nextgroup=perlVarMember,perlVarSimpleMember,perlMethod
endif
