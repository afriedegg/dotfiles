...
syn keyword pirOp debug_print backtrace getline getfile print_newline gcd
syn keyword pirOp splice slice iter morph exec classname trap pow
syn keyword pirOp getclass new instantiate pmcinfo add_io_event
syn keyword pirOp need_finalize newpdd15class substr_r close fdopen getfd
syn keyword pirOp getstdin getstdout getstderr setstdout setstderr pioctl
syn keyword pirOp open print say printerr read readline peek stat seek tell
syn keyword pirOp socket sockaddr connect recv send poll bind listen
...
syn keyword pirOp sprintf find_encoding stringinfo upcase downcase
